...
- [x] 02-08-PLAN.md — Orchestrator wiring: `ClaudeClient` thread-through, tool-timeout fix, CLI construction
...
- [x] 02-16-PLAN.md — Documentation and requirement-ledger truth-up: measured test counts, decision 26, Phase 2 requirement boxes (IN-01)
...
| 2. TTS Integration        | v1.2 | 16/16 | Complete   | 2026-08-02 |
