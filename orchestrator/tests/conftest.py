...
def _make_engine(
    rpm: float = 0,
    fuel_flow_gph: float = 0,
    oil_temp: float = 0,
    oil_pressure: float = 0,
    manifold_pressure: float = 0,
    egt: float = 0,
) -> EngineData:
    return EngineData(
        rpm=rpm,
...
def sim_state_parked() -> SimState:
    ...
    return _make_sim_state(
        ...
        speeds=Speeds(
            indicated_airspeed=0, true_airspeed=0, ground_speed=0, mach=0, vertical_speed=0
        ),
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=0, fuel_flow_gph=0, oil_temp=75, oil_pressure=0)],
        ),
...
def sim_state_taxiing() -> SimState:
    ...
    return _make_sim_state(
        ...
        speeds=Speeds(
            indicated_airspeed=12, true_airspeed=12, ground_speed=12, mach=0, vertical_speed=0
        ),
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=1800, fuel_flow_gph=8, oil_temp=180, oil_pressure=60)],
        ),
        surfaces=SurfaceState(gear_handle=True, flaps_percent=0, spoilers_percent=0),
...
def sim_state_takeoff_roll() -> SimState:
    ...
    return _make_sim_state(
        ...
        attitude=Attitude(pitch=0, bank=0, heading_true=90, heading_magnetic=87),
        speeds=Speeds(
            indicated_airspeed=55, true_airspeed=55, ground_speed=55, mach=0.08, vertical_speed=0
        ),
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=2700, fuel_flow_gph=14, oil_temp=200, oil_pressure=65)],
        ),
...
def sim_state_initial_climb() -> SimState:
    ...
    return _make_sim_state(
        ...
        speeds=Speeds(
            indicated_airspeed=85, true_airspeed=86, ground_speed=82, mach=0.13, vertical_speed=800
        ),
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=2700, fuel_flow_gph=14, oil_temp=200, oil_pressure=65)],
...
def sim_state_cruise() -> SimState:
    ...
    return _make_sim_state(
        ...
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=2400, fuel_flow_gph=9, oil_temp=190, oil_pressure=60)],
        ),
...
def sim_state_descent() -> SimState:
    ...
    return _make_sim_state(
        ...
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=2200, fuel_flow_gph=7, oil_temp=185, oil_pressure=58)],
        ),
        surfaces=SurfaceState(gear_handle=False, flaps_percent=0, spoilers_percent=0),
...
def sim_state_approach() -> SimState:
    ...
    return _make_sim_state(
        ...
        speeds=Speeds(
            indicated_airspeed=90, true_airspeed=92, ground_speed=88, mach=0.14, vertical_speed=-500
        ),
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=2100, fuel_flow_gph=8, oil_temp=190, oil_pressure=60)],
        ),
...
def sim_state_landing() -> SimState:
    ...
    return _make_sim_state(
        ...
        speeds=Speeds(
            indicated_airspeed=65, true_airspeed=66, ground_speed=62, mach=0.10, vertical_speed=-300
        ),
        engines=Engines(
            engine_count=1,
            engines=[_make_engine(rpm=1500, fuel_flow_gph=5, oil_temp=185, oil_pressure=58)],
        ),
...
def mock_chromadb_collection() -> MagicMock:
    ...
    coll.query.return_value = {
        ...
        "metadatas": [
            [{"source": "poh.pdf", "chunk_index": 0}, {"source": "poh.pdf", "chunk_index": 1}]
        ],
        "distances": [[0.12, 0.25]],
    }
